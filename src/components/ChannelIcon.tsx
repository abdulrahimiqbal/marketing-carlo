...
const STYLES: Record<ChannelType, { bg: string; fg: string; glyph: string; ring?: string }> = {
  ...
  youtube_ads: { bg: '#FF0000', fg: '#fff', glyph: '▶' },
  pinterest_ads: { bg: '#E60023', fg: '#fff', glyph: 'P' },
  snapchat_ads: { bg: '#FFFC00', fg: '#111', glyph: 'S', ring: '#e2e8f0' },
  ...
  product_hunt: { bg: '#DA552F', fg: '#fff', glyph: '▲' },
  seo_content: { bg: '#16A34A', fg: '#fff', glyph: 'Se' },
  newsletter: { bg: '#475569', fg: '#fff', glyph: '✉' },
  cold_email: { bg: '#64748B', fg: '#fff', glyph: '@' },
